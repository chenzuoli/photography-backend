...
public interface VoteRepository extends JpaRepository<Vote, String> {
    ...
    Vote addPhoto(String competition_id, String phone, String open_id, String image_url, String subject, String nick_name);

    @Transactional
    @Modifying
    @Query(value = "update vote set votes = ?1 where competition_id = ?2 and open_id = ?3", nativeQuery = true)
    Vote vote(int votes, String competition_id, String open_id);
