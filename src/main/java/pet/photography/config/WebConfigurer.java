...
public class WebConfigurer implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginInterceptor).addPathPatterns("/**").excludePathPatterns("/login", "/wx_login", "/register", "/sms_code", "/open_id", "/get_competitions", "/get_votes", "/get_photographies", "/get_comments");
